...
def get_persistent_uid():
    """Generates or retrieves a persistent UID using Browser Cookies to survive browser reloads/exits"""
    ...
    # 3. If no UID exists anywhere, generate a completely new one and save it to Cookie (Valid for 1 year)
